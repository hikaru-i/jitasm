...
struct test_sse4_2 : jitasm::function<void>
{
	virtual void naked_main()
	{
		...
		pcmpestri(xmm2, xmmword_ptr[esi], 0);
		pcmpestrm(xmm2, xmm1, 1);
		pcmpestrm(xmm2, xmmword_ptr[esi], 1);
		pcmpistri(xmm2, xmm1, 0);
		pcmpistri(xmm2, xmmword_ptr[esi], 0);
		pcmpistrm(xmm2, xmm1, 1);
		pcmpistrm(xmm2, xmmword_ptr[esi], 1);
		pcmpgtq(xmm0, xmm1);
		...
		pcmpestri(xmm10, xmmword_ptr[r8d], 0);
		pcmpestrm(xmm10, xmm9, 1);
		pcmpestrm(xmm10, xmmword_ptr[esi], 1);
		pcmpistri(xmm10, xmm9, 0);
		pcmpistri(xmm10, xmmword_ptr[esi], 0);
		pcmpistrm(xmm10, xmm9, 1);
		pcmpistrm(xmm10, xmmword_ptr[esi], 1);
		pcmpgtq(xmm8, xmm9);
