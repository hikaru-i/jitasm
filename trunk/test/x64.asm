...
masm_test_lea proc
	...
	lea rax, qword ptr[eax]
	lea rax, qword ptr[eax + 1]
	lea rax, qword ptr[ecx * 4]
	lea rax, qword ptr[ecx * 4 + 1]
	lea rax, qword ptr[eax + ecx]
	lea rax, qword ptr[eax + ecx * 4]
	lea rax, qword ptr[eax + ecx * 4 + 1]
	lea rax, qword ptr[rax]
	lea rax, qword ptr[rax + 1]
	lea rax, qword ptr[rcx * 4]
	lea rax, qword ptr[rcx * 4 + 1]
	lea rax, qword ptr[rax + rcx]
	lea rax, qword ptr[rax + rcx * 4]
	lea rax, qword ptr[rax + rcx * 4 + 1]
masm_test_lea endp
